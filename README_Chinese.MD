# 重要通知：我(@4accccc)将淡退此项目开发。全权交给@Winkmoon 和 @Nevoraa 代理。
# 还不去关注 @Winkmoon 和 @Nevoraa？ :3
...
- 首先安装Android Studio
- Windows用户，打开系统设置中的开发者模式(我们需要符号链接支持)。
- 安装Git:
...
- 要开始开发，请使用 Android Studio 打开项目。此 IDE 可用于APP（Kotlin/Java）和原生代码。
